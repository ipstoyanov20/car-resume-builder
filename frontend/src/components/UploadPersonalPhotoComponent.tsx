...
import { PersonalInfoVM, CarInfoVM } from "../api";
import { toast } from "react-toastify";


function UploadPersonalPhotoComponent({personalInfoVM, onCloseModal}:{personalInfoVM: PersonalInfoVM, onCloseModal: () => Promise<void>}) {
...
export default UploadPersonalPhotoComponent;