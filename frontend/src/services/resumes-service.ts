import { ResumesApi, ResumeIM, ResumeVM, CarInfoVM, ShareIM } from "../api";
...
export class ResumesService extends WebApiService {
    ...
    public async makeGetCarInfoFromResumeIdRequest(id: string): Promise<AxiosResponse<Array<CarInfoVM>>> {
        return await this.resumesApi.apiResumesIdCarInfoGet(id, this.generateHeader());
    }
