...
export const ResumesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiResumesIdDownloadGet(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<string>>> {
...
export const ResumesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiResumesIdDownloadGet(id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<string>> {
...
export class ResumesApi extends BaseAPI {
     ...
     * @memberof ResumesApi
     */
    public async apiResumesIdDownloadGet(id: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<string>> {
